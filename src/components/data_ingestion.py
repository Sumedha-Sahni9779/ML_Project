...
# Dynamically get project root (MLModels)
...
class DataIngestionConfig:
    ...
    source_data_path: str = os.path.join(PROJECT_ROOT, "Notebook/Data", "stud.csv")  # ✅ absolute path
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            logging.info(f"Read the dataset as dataframe from {self.ingestion_config.source_data_path}")
